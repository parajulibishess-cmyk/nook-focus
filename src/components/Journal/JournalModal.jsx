...
const JournalModal = ({ onClose, entries, setEntries }) => {
          ...
          <div className="flex flex-col md:flex-row flex-1 overflow-hidden bg-[#fcfcf7]">
              ...
              <div className="w-full md:w-1/2 p-6 border-b md:border-b-0 md:border-r border-[#e6e2d0] flex flex-col">
                  ...
                  <form onSubmit={addEntry} className="flex-1 flex flex-col">
                      <textarea 
                        ...
                        placeholder="Write down distracting thoughts here..." 
                        className="flex-1 w-full bg-white rounded-xl p-4 border-2 border-[#e6e2d0] resize-none focus:border-[#fdcb58] outline-none mb-4"
                      />
                      <div className="flex justify-end">
                          <Button type="submit" variant="secondary" icon={Save}>Save Entry</Button>
                      </div>
                  </form>
              </div>
              ...
              <div className="w-full md:w-1/2 p-6 overflow-y-auto bg-white">
                  ...
                  <div className="space-y-4">
                      ...
                      {entries.length === 0 && <div className="text-center text-gray-300 italic">No distractions recorded.</div>}
                  </div>
              </div>
          </div>
      </div>
